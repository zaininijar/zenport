    ...
    <div className="relative">
      <div className="fixed justify-end group -right-4 hover:right-8 md:right-8 bottom-14 md:bottom-32 z-40">
        <div className="hidden group-hover:block transition-all duration-500">
          <Link
            href={personalInformation.contacts[2]["link"]}
            target="_blank"
          ...
          <Link
            href={personalInformation.contacts[3]["link"]}
            target="_blank"
          ...
          <Link
            href={personalInformation.contacts[4]["link"]}
            target="_blank"
          ...
          <Link
            href={personalInformation.contacts[5]["link"]}
            target="_blank"
